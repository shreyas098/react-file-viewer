...
upgrade of there version using all the latest packages. The number of vulnerability warnings the current PlanGrid is generating left no choice but to fork. 
